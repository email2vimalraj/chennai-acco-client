              ...
              <div className="container">
                <div className="box">
                  <div className="price primary-color">
                    INR 3,000
                    <a href="#dummy" className="view-more">View Details</a>
                  </div>

                  <h5 className="mb-5"><a href="#dummy">154, Thambaram</a></h5>
                  <p>
            ...
            <div className="inner text-white">
              <div className="container">
                <div className="box">
                  ...
                  <h5 className="mb-5"><a href="#dummy">154, Anna Nagar, Chennai</a></h5>
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                      typesetting industry has...
                  </p>
            ...
            <div className="inner text-white">
              <div className="container">
                <div className="box">
                  ...
                  <h5 className="mb-5"><a href="#dummy">12, Greams Road, Chennai</a></h5>
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                      typesetting industry has...
                  </p>
